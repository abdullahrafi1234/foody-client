...
const ExtraOne = () => {
    return (
        <div className='my-12 mb-28'> 
            ...
            <div className='lg:flex-row md:flex-col flex flex-col  gap-8 justify-between'>
                <div className='lg:w-1/2 w-full lg:p-0 md:p-12 p-8 mt-8 h-[300px]'>
                    <img className='h-[600px] rounded-xl w-full' src="login food.jpeg" alt="" />
                </div>

                {/* faq  */}
                <div className="join join-vertical lg:w-1/2 p-10 lg:mt-8 md:mt-80 mt-80 ">
